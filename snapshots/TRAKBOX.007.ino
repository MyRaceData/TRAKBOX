...
/*
   TrakBox V1.007 8th version
   Andrew Rowe May 28 2023
   ...
   This version adds error check for hardware and prints warning to serial
...
void setup()
{
  ...
  delay(500);
  Serial.println("");
  Serial.println("TrakBox V1.007 starting"); Serial.println("");
