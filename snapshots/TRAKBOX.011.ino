...
/*
   TrakBox V1.011 12th version
   Andrew Rowe Oct 7 2023 finalized Nov 24 2023

   This version charges the file extension from .txt to .csv
   This version changes the order the data is written to the file
   ...
   For new output format see Write to SD card notes: below
...
void setup()
{
  ...
  delay(5000);
  Serial.println("");
  Serial.println("TrakBox V1.011 starting"); Serial.println("");
